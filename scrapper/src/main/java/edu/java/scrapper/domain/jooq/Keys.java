...
public class Keys {
    ...
    public static final UniqueKey<LinkTypeRecord> LINK_TYPE_PKEY = Internal.createUniqueKey(LinkType.LINK_TYPE, DSL.name("link_type_pkey"), new TableField[] { LinkType.LINK_TYPE.TYPE }, true);
    ...
    public static final ForeignKey<LinkRecord, LinkTypeRecord> LINK__FK_LINK_TYPE = Internal.createForeignKey(Link.LINK, DSL.name("fk_link_type"), new TableField[] { Link.LINK.TYPE }, Keys.LINK_TYPE_PKEY, new TableField[] { LinkType.LINK_TYPE.TYPE }, true);
}
