 ...
 */
@Generated(value = {"https://www.jooq.org", "jOOQ version:3.19.6"}, comments = "This class is generated by jOOQ")
@SuppressWarnings({"all", "unchecked", "rawtypes", "this-escape"}) public class Databasechangelog
    ...
    @ConstructorProperties({"id", "author", "filename", "dateexecuted", "orderexecuted", "exectype", "md5sum",
        "description", "comments", "tag", "liquibase", "contexts", "labels", "deploymentId"}) public Databasechangelog(
        @NotNull String id,
     ...
     */
    @jakarta.validation.constraints.NotNull @Size(max = 255) @NotNull public String getId() {
        return this.id;
    }
     ...
     */
    @jakarta.validation.constraints.NotNull @Size(max = 255) @NotNull public String getAuthor() {
        return this.author;
    }
     ...
     */
    @jakarta.validation.constraints.NotNull @Size(max = 255) @NotNull public String getFilename() {
     ...
     */
    @jakarta.validation.constraints.NotNull @NotNull public LocalDateTime getDateexecuted() {
     ...
     */
    @jakarta.validation.constraints.NotNull @NotNull public Integer getOrderexecuted() {
     ...
     */
    @jakarta.validation.constraints.NotNull @Size(max = 10) @NotNull public String getExectype() {
     ...
     */
    @Size(max = 35) @Nullable public String getMd5sum() {
        return this.md5sum;
    }
     ...
     */
    @Size(max = 255) @Nullable public String getDescription() {
     ...
     */
    @Size(max = 255) @Nullable public String getComments() {
     ...
     */
    @Size(max = 255) @Nullable public String getTag() {
        return this.tag;
    }
     ...
     */
    @Size(max = 20) @Nullable public String getLiquibase() {
     ...
     */
    @Size(max = 255) @Nullable public String getContexts() {
     ...
     */
    @Size(max = 255) @Nullable public String getLabels() {
        return this.labels;
    }
     ...
     */
    @Size(max = 10) @Nullable public String getDeploymentId() {
