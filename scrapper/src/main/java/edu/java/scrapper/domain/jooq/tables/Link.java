...
import edu.java.scrapper.domain.jooq.tables.ChatLink.ChatLinkPath;
...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> URL = createField(DSL.name("url"), SQLDataType.VARCHAR.nullable(false), this, "");
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> CHECKED_AT = createField(DSL.name("checked_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>public.link.type</code>.
     */
    public final TableField<LinkRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR(63).nullable(false), this, "");
    ...
    /**
     * The column <code>public.link.pull_request_count</code>.
     */
    public final TableField<LinkRecord, Integer> PULL_REQUEST_COUNT = createField(DSL.name("pull_request_count"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.link.commit_count</code>.
     */
    public final TableField<LinkRecord, Integer> COMMIT_COUNT = createField(DSL.name("commit_count"), SQLDataType.INTEGER, this, "");
    ...
    public List<ForeignKey<LinkRecord, ?>> getReferences() {
        return Arrays.asList(Keys.LINK__FK_LINK_TYPE);
    }

    private transient LinkType.LinkTypePath _linkType;

    /**
     * Get the implicit join path to the <code>public.link_type</code> table.
     */
    public LinkType.LinkTypePath linkType() {
        if (_linkType == null)
            _linkType = new LinkType.LinkTypePath(this, Keys.LINK__FK_LINK_TYPE, null);
    ...
    public ChatLinkPath chatLink() {
        if (_chatLink == null)
            _chatLink = new ChatLinkPath(this, null, Keys.CHAT_LINK__CHAT_LINK_LINK_ID_FKEY.getInverseKey());
