...
public class Chat extends TableImpl<ChatRecord> {
     ...
     */
    public final TableField<ChatRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    private transient ChatLink.ChatLinkPath _chatLink;

    /**
     * Get the implicit to-many join path to the <code>public.chat_link</code>
     * table
     */
    public ChatLink.ChatLinkPath chatLink() {
        if (_chatLink == null)
            _chatLink = new ChatLink.ChatLinkPath(this, null, Keys.CHAT_LINK__CHAT_LINK_CHAT_ID_FKEY.getInverseKey());
