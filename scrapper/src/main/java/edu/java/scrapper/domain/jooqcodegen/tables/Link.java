...
import edu.java.scrapper.domain.jooqcodegen.tables.ChatLink.ChatLinkPath;
...
public class Link extends TableImpl<LinkRecord> {
    ...
    public final TableField<LinkRecord, String> URL =
        createField(DSL.name("url"), SQLDataType.VARCHAR.nullable(false), this, "");
     ...
     */
    public final TableField<LinkRecord, Integer> COMMENT_COUNT =
        createField(DSL.name("comment_count"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.link.pull_request_count</code>.
     */
    public final TableField<LinkRecord, Integer> PULL_REQUEST_COUNT =
        createField(DSL.name("pull_request_count"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.link.commit_count</code>.
     */
    public final TableField<LinkRecord, Integer> COMMIT_COUNT =
        createField(DSL.name("commit_count"), SQLDataType.INTEGER, this, "");
