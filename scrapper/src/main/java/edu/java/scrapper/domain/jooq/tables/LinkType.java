...
public class LinkType extends TableImpl<LinkTypeRecord> {
     ...
     */
    public final TableField<LinkTypeRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR(63).nullable(false), this, "");
    ...
    public <O extends Record> LinkType(Table<O> path, ForeignKey<O, LinkTypeRecord> childPath, InverseForeignKey<O, LinkTypeRecord> parentPath) {
    ...
    public static class LinkTypePath extends LinkType implements Path<LinkTypeRecord> {
        ...
        private static final long serialVersionUID = 1L;
        public <O extends Record> LinkTypePath(Table<O> path, ForeignKey<O, LinkTypeRecord> childPath, InverseForeignKey<O, LinkTypeRecord> parentPath) {
